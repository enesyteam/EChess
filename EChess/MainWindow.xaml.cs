...
namespace SrcChess2 {
    ...
    public partial class MainWindow : Window, ChessBoardControl.IMoveListUI {
        ...
        /// <summary>Command: Cancel Play</summary>
        public static readonly RoutedUICommand ShowLostPiecesCommand = new RoutedUICommand("_Show Lost Pieces", "ShowLostPieces", typeof(MainWindow));
        /// <summary>Command: Cancel Play</summary>
        public static readonly RoutedUICommand ExportVideoCommand = new RoutedUICommand("_Export Game to Video", "ExportVideo", typeof(MainWindow));
        ...
        static MainWindow() {
            ...
            ShowLostPiecesCommand.InputGestures.Add(new KeyGesture(Key.F7));
            ExportVideoCommand.InputGestures.Add(new KeyGesture(Key.F6));
        ...
        public virtual void OnExecutedCmd(object sender, ExecutedRoutedEventArgs e) {
            ...
            else if (e.Command == ShowLostPiecesCommand)
            {
                ShowLostPieces();
            }
            else if (e.Command == ExportVideoCommand)
            {
                ExportVideo();
        ...
        {
            m_chessCtl.ExportToAvi();
        }

        private void ShowLostPieces()
        {

            this.m_lostPieces.Visibility = this.m_lostPieces.Visibility == System.Windows.Visibility.Visible ? System.Windows.Visibility.Collapsed : System.Windows.Visibility.Visible;
            //this.m_lostPieceWhite.Visibility = this.m_lostPieceWhite.Visibility == System.Windows.Visibility.Visible ? System.Windows.Visibility.Collapsed : System.Windows.Visibility.Visible;
        }
        ...
        public virtual void OnCanExecuteCmd(object sender, CanExecuteRoutedEventArgs e) {
            ...
            {
                e.CanExecute = m_moveViewer.listViewMoveList.Items.Count > 0;
            }
            else if (e.Command == UndoCommand) {
        ...
        private bool DisplayMessage(ChessBoard.MoveResultE eMoveResult, MessageModeE eMessageMode) {
            ...
            case ChessBoard.MoveResultE.TieNoMove:
                if (eMessageMode != MessageModeE.Silent) {
                    CheckStatus = "Draw. " + strOpponent + "unable to move.";
                }
                bRetVal = true;
                break;
            case ChessBoard.MoveResultE.TieNoMatePossible:
                if (eMessageMode != MessageModeE.Silent) {
                    CheckStatus = "Draw. Not enough pieces to make a checkmate.";
                }
                bRetVal = true;
                break;
            case ChessBoard.MoveResultE.ThreeFoldRepeat:
                if (eMessageMode != MessageModeE.Silent) {
                    CheckStatus  = "Draw. 3 times the same board.";
                }
                bRetVal = true;
                break;
            case ChessBoard.MoveResultE.FiftyRuleRepeat:
                if (eMessageMode != MessageModeE.Silent) {
                    CheckStatus = "Draw. 50 moves without moving a pawn or eating a piece.";
                }
                bRetVal = true;
                break;
            case ChessBoard.MoveResultE.Check:
                if (eMessageMode == MessageModeE.Verbose) {
                    CheckStatus = strOpponent + "in check.";
                }
                bRetVal = false;
                break;
            case ChessBoard.MoveResultE.Mate:
                if (eMessageMode != MessageModeE.Silent) {
                    CheckStatus = strOpponent + "checkmate.";
                }
                bRetVal = true;
                break;
            default:
        ...
        public static readonly DependencyProperty CheckStatusProperty = DependencyProperty.Register("CheckStatus",
                                                                  typeof(string),
                                                                  typeof(MainWindow));
        public string CheckStatus
        {
            get
            {
                return ((string)GetValue(CheckStatusProperty));
            }
            set
            {
                SetValue(CheckStatusProperty, value);
            }
        }
        /// <summary>
...

        ...
        /// </summary>
        public void ChooseBoardSetting() {
            frmBoardSetting         frm;
        ...
        public void ZoomOut()
        {
            //if (Board.Height < 100) return;
            //Board.Height = Convert.ToInt32(Board.Height / ZOOMFACTOR);
        }

        public void ZoomIn()
        {
            //if (Board.Height >= 1000) return;
            //Board.Height = Convert.ToInt32(Board.Height * ZOOMFACTOR);
        }
        ...
        private void m_toolbar_Loaded(object sender, RoutedEventArgs e)
        {
