...
namespace SrcChess2 {
    ...
    public class MoveItem {
        ...
        public MoveItem(string step, string who, string move, string desc) { Step = step; Who = who; Move = move; Desc = desc; }
            ...
            if (m_chessBoard != null) {
                ...
                if (iMoveCount != 0) {
                    ...
                    for (int iIndex = 0; iIndex < iMoveCount; iIndex++) {
                        ...
                        MoveList[iIndex]    = new MoveItem(strMoveIndex, moveItem.Who, strMove, "scd");
                    }
                }
            }
        }
